...
public:
  ...
  // MUNA: BELOW  ADDED BY MUNAWIRA for MORRIGAN
  uint8_t instruction, is_data, is_instr_addr, is_data_addr, is_stlb_prefetch = 0;

  int signature, confidence, free_bit, free_distance, lad, irip, conf;
  // MUNA: ABOVE ADDED BY MUNAWIRA for MORRIGAN
